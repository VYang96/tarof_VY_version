...
export const dict = {
  ...
  "home.hook": {
    zh: "当你卡在一个决定里，月语用一副笃定的牌阵，陪你穿过纷乱的思绪，看见一幅清晰的画面。",
    en: "When you're stuck on a decision, Moon-speak lays one steady spread — and walks you through the noise toward a clearer picture.",
  },
  "home.f1.title": { zh: "每日一牌", en: "Daily Card" },
  "home.f1.desc": { zh: "每天一张，一句话点醒此刻。", en: "One card a day, a line to center you." },
  "home.f2.title": { zh: "深度解读", en: "Deep Reading" },
  "home.f2.desc": { zh: "固定牌义打底，AI 说到心里。", en: "Fixed meanings, AI that speaks to you." },
